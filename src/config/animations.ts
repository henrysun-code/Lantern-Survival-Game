...
export const ANIMATIONS: Record<string, Record<string, AnimationDefinition>> = {
  player: {
    ...
    walkDown: { key: 'player_walk_down', texture: 'player', startFrame: 2, endFrame: 6, frameRate: 10, repeat: -1 },
    walkUp: { key: 'player_walk_up', texture: 'player', startFrame: 2, endFrame: 6, frameRate: 10, repeat: -1 },
    walkSide: { key: 'player_walk_side', texture: 'player', startFrame: 2, endFrame: 6, frameRate: 10, repeat: -1 },
