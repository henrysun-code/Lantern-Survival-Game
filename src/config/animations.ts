...
export const ANIMATIONS: Record<string, Record<string, AnimationDefinition>> = {
  ...
  enemyMelee: {
    ...
    move: { key: 'melee_move', texture: 'enemyMelee', startFrame: 0, endFrame: 5, frameRate: 8, repeat: -1 },
    attack: { key: 'melee_attack', texture: 'enemyMelee', startFrame: 6, endFrame: 9, frameRate: 10, repeat: 0 },
    hurt: { key: 'melee_hurt', texture: 'enemyMelee', startFrame: 10, endFrame: 11, frameRate: 12, repeat: 0 },
    death: { key: 'melee_death', texture: 'enemyMelee', startFrame: 12, endFrame: 14, frameRate: 8, repeat: 0 },
  },
  enemyRanged: {
    idle: { key: 'ranged_idle', texture: 'enemyRanged', startFrame: 0, endFrame: 0, frameRate: 6, repeat: -1 },
    move: { key: 'ranged_move', texture: 'enemyRanged', startFrame: 0, endFrame: 5, frameRate: 8, repeat: -1 },
    attack: { key: 'ranged_attack', texture: 'enemyRanged', startFrame: 9, endFrame: 10, frameRate: 10, repeat: 0 },
    hurt: { key: 'ranged_hurt', texture: 'enemyRanged', startFrame: 10, endFrame: 11, frameRate: 12, repeat: 0 },
    death: { key: 'ranged_death', texture: 'enemyRanged', startFrame: 12, endFrame: 14, frameRate: 8, repeat: 0 },
  },
  enemyMosquito: {
    idle: { key: 'mosquito_idle', texture: 'enemyMosquito', startFrame: 0, endFrame: 0, frameRate: 6, repeat: -1 },
    move: { key: 'mosquito_move', texture: 'enemyMosquito', startFrame: 0, endFrame: 5, frameRate: 10, repeat: -1 },
    attack: { key: 'mosquito_attack', texture: 'enemyMosquito', startFrame: 6, endFrame: 9, frameRate: 12, repeat: 0 },
    hurt: { key: 'mosquito_hurt', texture: 'enemyMosquito', startFrame: 10, endFrame: 11, frameRate: 12, repeat: 0 },
    death: { key: 'mosquito_death', texture: 'enemyMosquito', startFrame: 12, endFrame: 14, frameRate: 8, repeat: 0 },
  },
};
